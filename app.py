                        ...
                        <table class="min-w-full divide-y divide-gray-700">
                            ...
                            <tbody class="bg-gray-800 divide-y divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-700/50 transition-colors">
                                    ...
                                    <td class="px-5 py-4 whitespace-nowraws-center text-sm text-gray-400">
                                        {% if acc.bot_name %}
...
def init_db():
    ...
    try:
        # Đảm bảo thư mục cho CSDL tồn tại (quan trọng khi dùng /data)
